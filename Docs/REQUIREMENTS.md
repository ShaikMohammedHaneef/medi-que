...
| BR-1.20 | A doctor may be created only under an existing department.                                                                                                                                                                                               |
| BR-1.21 | Doctors marked as **inactive** shall not receive new OP bookings or access the system.                                                                                                                                                                   |
| BR-1.22 | Doctors shall not be permanently deleted; they may only be activated or deactivated.                                                                                                                                                                     |
| BR-1.23 | If a doctor is marked as **inactive**, the system shall automatically mark the doctor as **unavailable**.                                                                                                                                                |
