...
Installation instructions will be added after the initial development phase.


# Running the Application

Instructions for running the frontend and backend locally will be added after the initial development phase.
